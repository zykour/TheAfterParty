...
public class DbInit : DropCreateDatabaseAlways<AppIdentityDbContext>
{
    ...
    public void PerformInitialSetup(AppIdentityDbContext context)
    {
        ...
        l.AddProduct(p);
        l.AddPlatform(steam);
        ProductKey pk = new ProductKey("ASD09-SDF7A-9D70S", steam);
        l.AddProductKey(pk);
        pk = new ProductKey("FSD07-SDFSD-ZB9S9", steam);
        l.AddProductKey(pk);
        l.Product.AddTag(td);
        ...
        l.AddPlatform(steam);
        l.AddProduct(p);
        pk = new ProductKey("4A07B-SDS8N-MANSB", steam);
        l.AddProductKey(pk);
        ...
        l.AddPlatform(steam);
        l.AddProduct(p);
        pk = new ProductKey("42B00-SD9Z8-BSBWN", steam);
        l.AddProductKey(pk);
        pk = new ProductKey("NMSMW-AS9B8-SJZJW", steam);
        l.AddProductKey(pk);
        l.Product.AddTag(racing);
        l.Product.AddTag(action);
        l.Product.AddProductCategory(sp);
        ...
        l.AddPlatform(steam);
        l.AddProduct(p);
        pk = new ProductKey("W0B0Z-SHDFM-AW88W", steam);
        l.AddProductKey(pk);
        pk = new ProductKey("N0SHZ-S9D9F-BHZHZ", steam);
        l.AddProductKey(pk);
        ...
        l.AddPlatform(steam);
        l.AddProduct(p);
        pk = new ProductKey("BAH0Z-29GGU-AQW2M", steam);
        l.AddProductKey(pk);
        pk = new ProductKey("YXUB0-SYWBZM-S8CYB", steam);
        l.AddProductKey(pk);
        ...
        l.AddPlatform(steam);
        l.AddProduct(p);
        pk = new ProductKey("N0WHE-ATL3Y-ISBST", steam);
        l.AddProductKey(pk);
        pk = new ProductKey("GL4D0-S1S7H-EB3ST", steam);
        l.AddProductKey(pk);
        ...
        l.AddPlatform(gog);
        l.AddProduct(p);
        pk = new ProductKey(true, "", gog);
        l.AddProductKey(pk);
        pk = new ProductKey("WITCH-ER3KE-Y1234", gog);
        l.AddProductKey(pk);
        pk = new ProductKey("WITCH-ER3KE-Y5678", gog);
        l.AddProductKey(pk);
        l.Product.AddTag(action);
        l.Product.AddTag(rpg);
        l.Product.AddProductCategory(sp);
